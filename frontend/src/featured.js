    ...
    return (
      <div className="bg-white rounded-lg px-6 py-8 flex flex-col justify-between gap-6 shadow-md transition-shadow hover:shadow-lg">
        <div className="flex items-center gap-4">
          ...
          <span>
            <p style={{textAlign: 'left'}} className="text-2xl font-semibold">{title}</p>
            <p style={{textAlign: 'left'}} className="text-lg">1 Opening</p>
          </span>
        </div>
        <div>
          <p style={{textAlign: 'left'}} className="text-2xl font-semibold">{position}</p>
          <div className="flex justify-between items-center text-xl pt-4">
            <p style={{textAlign: 'left'}} className="flex items-center gap-2">
              <HiGlobe className="text-2xl" /> {location}
            </p>
            <p style={{textAlign: 'left'}} className="text-gray-500">{type}</p>
          </div>
        </div>
        <div className="flex items-center justify-between">
          <span>
            <p style={{textAlign: 'left'}} className="text-gray-500 text-lg">July 23, 2024 by</p>
            <p style={{textAlign: 'left'}} className="text-xl font-medium">{company}</p>
          </span>
          <button
  ...
  return (
    <div className="bg-[#fcfaf6]">
      <div className="container mx-auto px-6 py-24">
        ...
        <p style={{textAlign: 'left'}} className="text-2xl mt-4 font-light">
