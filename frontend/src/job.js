...
const Job = () => {
  ...
  const [jobBg, setJobBg] = useState('');
  const [jobBgColor, setJobBgColor] = useState('');
  ...
  const handleJobCardClick = (bgColor, title) => {
    const number = Math.floor(Math.random() * 10);
    const url = `https://unsplash.it/640/425?image=${number}`;
    setJobBg(url);
    setJobBgColor(bgColor);
    setJobTitle(title);
      ...
      <div className="wrapper">
        <div className="search-menu">
          <div className="search-bar">
            <input type="text" className="search-box" style={{ border: 'none', marginRight: '250px'}} autofocus />
            <div className="search item" style={{marginLeft: '20px'}}>Product Designer
          ...
          <div className="search-type">
            ...
            <div className="job-time">
              ...
              <div className="job-wrapper">
                <div className="type-container">
                  <input type="checkbox" id="job1" className="job-style" defaultChecked />
            ...
            <div className="job-time">
              ...
              <div className="job-wrapper">
                ...
                <div className="type-container">
                  <input type="checkbox" id="job9" className="job-style" defaultChecked />
                  <label htmlFor="job9">Mid Level</label>
                  <span className="job-number">35</span>
                </div>
                <div className="type-container">
                  <input type="checkbox" id="job10" className="job-style" defaultChecked />
            ...
            <div className="job-time">
              ...
              <div className="job-wrapper">
                ...
                <div className="type-container">
                  <input type="checkbox" id="job5" className="job-style" defaultChecked />
                  <label htmlFor="job5">$2000 - $3000</label>
                  <span className="job-number">76</span>
                </div>
                <div className="type-container">
                  <input type="checkbox" id="job6" className="job-style" defaultChecked />
